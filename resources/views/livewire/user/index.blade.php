                            ...
                            <div x-data="{ opened_tab: null }" class="flex flex-col">
                                <div class="flex flex-col border rounded shadow mb-2">
                                    <div @click="opened_tab = opened_tab == {{ $index }} ? null : {{ $index }} "
                                        class="text-sm font-medium text-gray-700 dark:text-gray-400 p-2 cursor-pointer flex justify-between hover:text-base">
                                        <div class="flex items-center">
                                            <button
                                    ...
                                    <div x-show="opened_tab=={{ $index }}" class="p-4 pb-4 text-gray-500">
                                        <div class="flex justify-between">
                                            ...
                                            <div class="flex items-end">
                                                ...
                                                @can('user_delete')
                                                    @if ($user->deleted_at)
                                                        <svg wire:click='condirmActiveUser({{ $user->id }})'
                                                    ...
                                                    @else
                                                        <svg wire:click='condirmDesativeUser({{ $user->id }})'
                                                            xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                            class="w-6 h-6 mr-3 text-green-600 cursor-pointer"
                                                            alt="Verificado">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
